...
// /**
//  * Tạo lịch thi đấu tự động cho TẤT CẢ nội dung
//  */
// export const generateAllTournamentSchedules = async (
//   tournamentId: string
// ): Promise<void> => {
//   const tournament = await getTournamentById(tournamentId);
//   if (!tournament) throw new Error('Tournament not found');
...
//   let allNewTeams: TournamentTeam[] = [...tournament.teams];
//   let allNewGroups: TournamentGroup[] = [...(tournament.groups || [])];
  
//   // Tạo lịch cho TỪNG nội dung
...
//       console.warn(`Not enough participants for ${category}: ${categoryParticipants.length}`);
//       continue;
//     }
...
//       allNewTeams = [...allNewTeams, ...teams];
//     }
    
//     let categoryMatches: TournamentMatch[] = [];
//     let matchNumber = allNewMatches.length + 1;
...
//           matchNumber
//         );
//         categoryMatches = [...categoryMatches, ...groupMatches];
//         matchNumber += groupMatches.length;
//       });
      
//       allNewGroups = [...allNewGroups, ...groups];
//     } else if (tournament.format === 'single_elimination') {
//       categoryMatches = generateSingleEliminationBracket(
//         tournamentId,
//         category,
...
//       categoryMatches = categoryMatches.map((match, idx) => ({
//         ...match,
//         matchNumber: matchNumber + idx,
//       }));
//       matchNumber += categoryMatches.length;
//     }
    
//     allNewMatches = [...allNewMatches, ...categoryMatches];
//   }
  
//   // Cập nhật tất cả một lần
...
// /**
//  * Tạo lịch thi đấu tự động cho MỘT nội dung (legacy)
//  */
